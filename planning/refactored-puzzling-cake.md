...
## Twitter/X
1. Post a thread for each project on the logged-in X account
2. Tag relevant accounts: @rustlang, @ThePSF, use hashtags #Python #Rust #DataEngineering

## Verification
- Confirm each comment/post appears live in the browser after submission
