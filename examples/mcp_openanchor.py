"""Example: OpenAnchor MCP 2.0 Integration"""

import asyncio
from openanchor import PerceptionEngine  # Adjust import based on project
...
async def main():
    ...
    print(f"✓ OpenAnchor MCP 2.0 running at {mcp_url}")
